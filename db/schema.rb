...
ActiveRecord::Schema.define(version: 2021_09_23_082250) do
  ...
  create_table "designations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.bigint "company_id"
  ...
  create_table "users_benefits", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.float "amount", null: false
    t.bigint "benefit_id", null: false
    t.bigint "user_id", null: false
    t.bigint "company_id", null: false
